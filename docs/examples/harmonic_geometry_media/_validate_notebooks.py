"""Smoke-test the harmonic_geometry.media notebooks. Same pattern as the
geometry smoke test — exec every code cell, report cell index of any
failure with the offending source. Headless via Agg, UTF-8 safe on Windows.
"""
